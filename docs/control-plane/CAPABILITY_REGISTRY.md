...
| generated-artifacts | Source/generated boundaries and regeneration | ACTIVE | `.keel/bootstrap-manifest.json` has a repository-owned producer and deterministic drift check | Producer provenance + generator + freshness check |
