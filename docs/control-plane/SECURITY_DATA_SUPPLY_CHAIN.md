# Security, Data, Privacy, and Supply Chain

## Always-on baseline
- no secrets in source/docs/logs;
- least privilege;
...
Compliance/legal controls must come from authoritative requirements; never invent certification or regulatory obligations.
