...
Start at root `AGENTS.md`; load detail only when relevant.
...
- [product-specs/](product-specs/README.md)
...
- [Decision model](control-plane/DECISION_MODEL.md)
- [Verification](control-plane/VERIFICATION.md)
- [Architecture enforcement](control-plane/ARCHITECTURE_ENFORCEMENT.md)
- [Environment/worktree model](control-plane/ENVIRONMENTS.md)
- [Canonical commands/tooling](control-plane/COMMANDS.md)
- [Testing, CI and generated artifacts](control-plane/TESTING_CI_GENERATED.md)
...
- [Context architecture](control-plane/KEEL_CONTEXT.md)
- [Parallel/worktree model](control-plane/KEEL_PARALLEL.md)
- [Emergency bypass](control-plane/KEEL_EMERGENCY.md)
