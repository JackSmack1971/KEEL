...
plan = (ROOT / "docs/exec-plans/active/p1-repository-intelligence-foundation.md").read_text(encoding="utf-8")
...
for phrase in ("P1 → **CURRENT AUTHORIZED WORKSTREAM**", "P2 → **NOT INSTANTIATED**", "P4 → **BLOCKED**", "D1 → **DEFERRED**"):
