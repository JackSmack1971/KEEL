...
records = [
    ...
    sk.EffectRequest(**common("effect-request", "local-write"), effect_type="filesystem.write", subject_id="keel:work-unit:kernel", action="write", resource="repo:.keel/lib/semantic_kernel.py", intent_digest=D),
    sk.CapabilityGrant(**common("capability-grant", "local-write"), subject_id="keel:work-unit:kernel", effect_request_id="keel:effect-request:local-write", issuer="operator", work_id="kernel", change_id="semantic-kernel", action="write", resource="repo:.keel/lib/semantic_kernel.py", intent_digest=D, evidence_reference="operator:contract"),
