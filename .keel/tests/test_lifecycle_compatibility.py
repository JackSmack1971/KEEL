...
with tempfile.TemporaryDirectory() as directory:
    ...
    for path, value in ((root / ".keel/config.json", {"schema_version": 99}), (root / ".keel/contracts.json", {"schema_version": 1}), (root / ".keel/bootstrap-manifest.json", {"schema_version": 2}), (root / ".keel/ledger/example/state.json", {"schema_version": 7, "phase": "EXECUTE"})):
