...
5. If changing KEEL, Codex hooks/rules/MCP/subagents, verify current official Codex syntax, least privilege, project/hook trust behavior, failure handling, context cost, and permission boundaries. A KEEL enforcement change is high-risk/control-plane work and must be independently reviewed.
